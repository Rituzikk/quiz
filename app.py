...
questions_db = {
    ...
    "medium": [
        {"question": "Что выведет lst = [1,2,3]; print(lst[::-1])?",
        ...
        {"question": "Что произойдёт: x = [1,2,3]; y = x; y.append(4); print(x)?",
        ...
        {"question": "Что делает list(map(int, ['1','2','3']))?",
        ...
        {"question": "Что выведет print(0.1 + 0.2 == 0.3)?",
        ...
        {"question": "Как создать генератор списка квадратов чисел 0-9?",
         "options": ["[x**2 for x in range(10)]", "[x^2 for x in range(10)]", "map(x**2, range(10))",
                     "[x*2 for x in range(10)]"],
         "correct": "[x**2 for x in range(10)]",
         "explanation": "List comprehension: [выражение for элемент in последовательность]."},
        ...
        {"question": "Что выведет set([1,2,2,3,3,3])?",
        ...
        {"question": "Что выведет print(True + True + False)?",
    ...
    "hard": [
        {
            "question": "Что выведет код?<br><code>def f(x, lst=[]):<br>    lst.append(x)<br>    return lst<br><br>print(f(1))<br>print(f(2))</code>",
        ...
        {"question": "Какой баг уничтожил ракету Ariane 5?",
        ...
        {"question": "Что делает оператор is?",
         "options": ["Сравнивает значения", "Сравнивает идентичность объектов", "Проверяет тип",
                     "Выполняет присваивание"],
         "correct": "Сравнивает идентичность объектов",
         "explanation": "is проверяет, ссылаются ли переменные на один объект в памяти."},
        {"question": "Что выведет print(not (False or True) and False)?",
         "options": ["True", "False", "None", "Ошибка"], "correct": "False",
         "explanation": "False or True = True, not True = False, False and False = False."},
        {"question": "Что такое метакласс в Python?",
         "options": ["Класс класса", "Абстрактный класс", "Декоратор класса", "Миксин"], "correct": "Класс класса",
         "explanation": "Метакласс — это класс, который создаёт другие классы (например, type)."},
        {"question": "Какой результат float('inf') > 10**1000?",
         "options": ["True", "False", "None", "Ошибка"], "correct": "True",
         "explanation": "inf — бесконечность, больше любого числа."},
        {"question": "Что такое @property?",
         "options": ["Декоратор для методов-геттеров", "Декоратор для статических методов", "Декоратор для классов",
                     "Декоратор для итераторов"],
         "correct": "Декоратор для методов-геттеров",
         "explanation": "@property позволяет обращаться к методу как к атрибуту."},
        {"question": "Что выведет print(1_000_000)?",
        ...
        {"question": "Что такое слайс (slice) с шагом?",
        ...
        {"question": "Что выведет print(all([True, False, True]))?",
         "options": ["True", "False", "None", "Ошибка"], "correct": "False",
         "explanation": "all() возвращает True только если все элементы True."},
        {"question": "Что такое functools.lru_cache?",
         "options": ["Кэширование результатов вызовов функций", "Логирование", "Профилирование", "Работа с файлами"],
         "correct": "Кэширование результатов вызовов функций",
         "explanation": "lru_cache запоминает результаты вызовов для ускорения."},
        {"question": "Что произойдёт при import module во второй раз?",
        ...
        {"question": "Что выведет print(bytearray(b'Hello')[0])?",
         "options": ["72", "H", "72.0", "Ошибка"], "correct": "72",
         "explanation": "bytearray возвращает числа (коды символов). 'H' имеет код 72."},
        {"question": "Что выведет print(bool([]), bool([0]))?",
        ...
        {"question": "Что выведет print(0 == False and 1 == True)?",
         "options": ["True", "False", "None", "Ошибка"], "correct": "True",
